...
We'll now switch to a data set which is more useful for illustrating the full
range of random effects structures and which will also be useful when we turn 
to the question of auto-correlation (@sec-auto).

We will take up data shared in the course of 

We will take trajectories from the [price]{.smallcaps} vowel, looking at both
F1 and F2.
...
however, a potential time sync. Try to balance the costs and benefits when you

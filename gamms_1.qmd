...
We will first look at some examples 'in the wild'. All of these are adequate
for publication! I will then give a few opinions.

::: {.panel-tabset}

### Renwick et al. (2023)

Renwick, Margaret E. L., Joseph A. Stanley, Jon Forrest, and Lelia Glass. 2023. “Boomer Peak or Gen X Cliff? From SVS to LBMS in Georgia English.” _Language Variation and Change_ 35(2): 175–97. https://doi.org/10.1017/S095439452300011X. 
...
As in @renwickBoomerPeakGen2023, this reports _many_ GAMMs fit to readings from
vowels. However, there is significantly more detail concerning the GAMMs in 
supplementary material for this paper.

### Derrick and Gick (2022)

This is a shorter piece for _Scientific Reports_. Space is at a premium!

### An example with reaction time or other more experimental data.

:::

- Cite the specific packages. (help: citation(), `grateful`).
- Cite specific R functions
- Text **in the article** can be terse, _as long as_ there is a link to the specific code.
- The 'difference smooth' structure needs to be clear...
- Visualisations are an important part of evaluating GAMMs (moreso than for linear models where a single coefficient is what you are testing).
  - Your discussion section might consist of description of the specific trajectories you find visually. (as in  @renwickBoomerPeakGen2023.) TODO: add fuller list.
- Model comparisons often used.

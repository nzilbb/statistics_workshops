...
To see what functions `cowsay` has, look at the documentation. In this case, 
if you enter `?cowsay` you will see a link at the bottom of the help page.
Alternatively, if you just want to see the names of functions, you can enter
`cowsay::` and RStudio will suggest the names of functions.

The main function which comes with `cowsay` is called `say`, so enter `?say` in
the console.
